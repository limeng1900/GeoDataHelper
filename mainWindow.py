...
from PyQt5.QtWidgets import QDesktopWidget,QApplication,QMainWindow,QWidget,QVBoxLayout,QHBoxLayout,QPushButton,QSpacerItem,QTableView,QSizePolicy,QStatusBar
